...
class ChemicalCalculationsWidget(QWidget):
    ...
    def add_calculator_pages(self):
        ...
        page_configs = [
            ...
            ("🧹 篮式过滤器", "BasketFilterDesignCalculator", "basket_filter_design_calculator", True),
            ...
            ("🔥 换热器面积", "HeatExchangerAreaCalculator", "heat_exchanger_area_calculator", True),
            ("⚖️ 罐体重量", "TankWeightCalculator", "tank_weight_calculator", False),
